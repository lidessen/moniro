...
export class SkillsProvider {
   ...
   */
  private async parseFrontmatter(skillMdPath: string): Promise<z.infer<typeof frontmatterSchema>> {
   ...
   */
  private parseFrontmatterSync(skillMdPath: string): z.infer<typeof frontmatterSchema> {
   ...
   */
  async addImportedSkills(importer: { getAllImportedSkillPaths(): string[] }): Promise<void> {
   ...
   */
  addImportedSkillsSync(importer: { getAllImportedSkillPaths(): string[] }): void {
    const skillPaths = importer.getAllImportedSkillPaths();
