/**
 * Bash tools for personal agents.
 *
 * Re-exported from @moniro/agent-worker so personal agents can use bash
 * without depending on the workspace layer.
 *
 * Wraps Vercel's bash-tool package with AI SDK compatible tool() objects.
 */
