...
- [`6c2ac3f`](https://github.com/lidessen/moniro/commit/6c2ac3f1de88a4e42d125152e3607c11a2025bf3) - Major architecture refactor: three-package split, adds conversation model and daemon registry

- [`d67a1bb`](https://github.com/lidessen/moniro/commit/d67a1bbf0632edbea5d5ab32f4d6d3cc337440dc) - feat: Priority Queue + Cooperative Preemption - Three-lane priority queue (immediate > normal > background) replaces FIFO inbox processing. Agents yield between LLM steps when higher-priority instructions arrive, preserving progress for seamless resume. AgentHandle.send()/sendMessage() convenience methods for typed instruction routing. Scheduled wakeups enqueue directly as background priority.

- [`25062a7`](https://github.com/lidessen/moniro/commit/25062a7decd623e6cee78646fda038bf45704eef) - Replace SkillsProvider with bash-tool createSkillTool, remove internal package builds, fix path aliases, add test model injection

### Patch Changes

- [`2c80b23`](https://github.com/lidessen/moniro/commit/2c80b23841460c133dadb115c7c8948a12c4e169) - Fix TypeScript duplicate type resolution by removing preserveSymlinks from tsconfig
...
- [`bb7b1a6`](https://github.com/lidessen/moniro/commit/bb7b1a6ee1012b887ba3287af5950cf4649d4257) - feat: unify interface-daemon-worker three-layer architecture with factory primitives and sendDirect()
