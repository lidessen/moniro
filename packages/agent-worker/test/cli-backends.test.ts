...
describe("Codex Adapter", () => {
  ...
  test("formats thread.started event", () => {
    const event = codexAdapter({
      type: "thread.started",
      thread_id: "019c4173-117f-75b0-afa9-3b1affdec150",
    })!;
  ...
  test("formats turn.completed event", () => {
    const event = codexAdapter({
      type: "turn.completed",
      usage: { input_tokens: 8133, output_tokens: 5 },
    })!;
